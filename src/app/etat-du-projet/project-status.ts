...
export const projectStatus = {
  ...
  currentFocus: "Story 3.3 · Navigation clavier et aides techniques",
  nextFocus: "Story 3.3 · Valider les parcours fléchés et le reflow",
  epics: [
    {
      id: "1",
    ...
    { id: "3", title: "Bibliothèque physique et personnelle", value: "Contempler et personnaliser une bibliothèque alimentée.", status: "in-progress", stories: [
      ...
      { id: "3.3", title: "Naviguer au clavier et avec aides techniques", status: "in-progress" },
